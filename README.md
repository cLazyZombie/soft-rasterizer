...
현재 저장소는 25장짜리 구현 교재와 확정된 렌더링 계약을 따라 장별로 구현합니다. 2장까지 Rust가 소유한 RGBA8/깊이 버퍼를 Canvas 2D에 표시하고, 작은 입력 snapshot을 프레임당 한 번의 고수준 Rust-Wasm 호출로 전달하며 경계 호출 수와 단계 시간을 관찰할 수 있습니다.
